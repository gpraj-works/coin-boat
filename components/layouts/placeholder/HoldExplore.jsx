	...
	return (
		<>
			{[...Array(HoldCount)].map((item, index) => (
				<div
					role='status'
					className={`animate-pulse flex md:flex-row sm:flex-col flex-wrap ${classProps} px-4 w-full items-center border-[0.3px] dark:border-gray-800`}
					key={index}
				>
					<div className='h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 w-[3%] mx-2'></div>
