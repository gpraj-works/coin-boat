...
const HoldNews = ({ count, classNameProps }) => {
	...
	return (
		<>
			{[...Array(HoldCount)].map((item, index) => (
				<div
					role='status'
					className={`space-y-8 animate-pulse md:space-y-0 md:space-x-8 md:flex md:items-center ${classNameProps}`}
					key={index}
				>
